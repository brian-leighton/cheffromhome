    ...
    return(
            <UtilityCenter x="true">
                ...
                <div className="section__heading u-margin-bottom-large">
                    <h1 className="heading heading__primary heading__primary--large u-margin-top-medium">{recipe.about.title}</h1>
                    ...
                    <div className="section__heading--sub-container">
                        ...
                        <div className={`difficulty ${difficulty <= 2 ? "easy" : difficulty > 2 && difficulty < 4 ? "medium" : "hard"}`}>
                            ...
                            <h4 className="difficulty__content">{recipe.about.cookTime}</h4>
                        </div>
                ...
                <div className="section__about--text">
                    {/* {recipe.about.description.map(p => <p className="u-margin-bottom-small" key={p.slice(0, 10)}>{p}</p>)} */}
                    <p className="u-margin-bottom-small">{recipe.about.description}</p>
                </div>
